...
def get_context(context):
	...
	for contribution in contributions:
		...
		if contribution.new:
			contribution.edit_link = f"/new?wiki_page={route}&wiki_page_patch={contribution.name}&new=1"
		else:
			contribution.edit_link = f"/edit?wiki_page={route}&wiki_page_patch={contribution.name}"
