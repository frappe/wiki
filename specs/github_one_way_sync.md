...
- [ ] TB1b-ii — Frontend read-only (non-CR tree render, editor non-editable, hidden mutation affordances, badge) + create-space "Git synced" dialog.
- [ ] TB2 — Edit on GitHub
- [ ] TB3 — `.wiki.json` structure override
- [ ] TB4 — GitHub App connection + repo picker (private repos)
- [ ] TB5 — Sync log & status panel
