...
mkdir ~/frappe-bench/sites/wiki.test
cp "${GITHUB_WORKSPACE}/.github/helper/site_config.json" ~/frappe-bench/sites/wiki.test/site_config.json
...
bench --site wiki.test execute wiki.wiki.doctype.wiki_page.search.rebuild_index
